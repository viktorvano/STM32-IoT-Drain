...
int main(void)
{
  ...
  MX_TIM4_Init();
  /* USER CODE BEGIN 2 */
	HAL_TIM_Base_Start_IT(&htim2);// 20 milliseconds - interrupt
	HAL_TIM_Base_Start_IT(&htim3);// 1 second - interrupt
	HAL_TIM_Base_Start(&htim4);// 20 ms PWM
